    ...
    oFReader.onloadend = function() {
      ...
      json.forEach(function(o){
        ...
        var obj = {
          ...
          imgurl: o.image_url,
          work_school: o.does_this_image_take_place_at_work_or_school,
          setting: o.what_type_of_job_or_work_setting_is_featured_in_the_image,
          situation: o.what_type_of_situation_or_activity_is_taking_place_in_the_image,
          scenario: o.what_is_the_main_scenario_portrayed_in_the_image,
          image_setting: o.what_type_of_setting_does_the_image_take_place_in
        }

        var keywords = obj.work_school + ' ' + obj.setting + ' ' + obj.situation + ' ' + obj.scenario + ' ' + obj.image_setting;
