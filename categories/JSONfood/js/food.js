    ...
    oFReader.onloadend = function() {
      ...
      json.forEach(function(o){
        ...
        var obj = {
          ...
          imgurl: o.image_url,
          ingredients: o.does_the_image_focus_on_ingredients_by_themselves_or_prepared_meals_or_dishes,
          food: o.what_type_of_food_is_in_the_image,
          activities: o.which_foodrelated_activities_if_any_are_taking_place_in_the_image,
          scenario: o.what_is_the_main_scenario_portrayed_in_the_image,
          objects: o.what_types_of_objects_are_in_the_image
        }

        var keywords = obj.ingredients + ' ' + obj.food + ' ' + obj.activities + ' ' + obj.activities + ' ' + obj.scenario + ' ' + obj.objects + ' ' + obj.position;
